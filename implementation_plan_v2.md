...
| `AiScanController.java` | `POST /api/ai-scan/log` |
...
#### [NEW] Models (`models/`)
- Mirror các DTO từ backend: `User.java`, `Account.java`, `Category.java`, `Transaction.java`, `Budget.java`, `Notification.java`, `AiScanLog.java`
