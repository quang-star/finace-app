...
OCR dùng ML Kit trên Android và Gemini trên backend. YOLO và Random Forest sản phẩm chạy cục bộ trên Android.
...
YOLO/TFLite phát hiện vật thể và Random Forest local gợi ý danh mục trực tiếp trên Android. Kết quả được truyền vào form thêm giao dịch, không gọi backend AI Product.
